...
<section class=" blog-posts w-100 float-left">
    <div class="container">
        <div class="row">
                        ...
                        <div class="float-left w-100 post-item border mb-4">
                            <div class="post-item-wrap position-relative">
                                <div class="post-image">
                                    <a href="#">
                                        <img alt="" src="assets/image/standard_post_img01.jpg">
                                    </a>
                                ...
                                <div id="blogslider" class="carousel slide" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="carousel-item active">
                                            <img src="assets/image/standard_post_img02.jpg" alt="">
                                            <!--carousel-item-->
                                        </div>
                                        <div class="carousel-item">
                                            <img src="assets/image/standard_post_img04.jpg" alt="">
                                            <!--carousel-item-->
                                        </div>
                                        <div class="carousel-item">
                                            <img src="assets/image/standard_post_img06.jpg" alt="">
                                            <!--carousel-item-->
                                        </div>
                                        <!--carousel-inner-->
                                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="float-left w-100 post-item border mb-4">
                            <div class="post-item-wrap position-relative">
                                <div class="post-image">
                                    <a href="#">
                                        <img alt="" src="assets/image/standard_post_img03.jpg"> </a> <span
                        ...
                        <div class="float-left w-100 post-item border mb-4">
                            <div class="post-item-wrap position-relative">
                                <div class="post-audio position-relative">
                                    <a href="#">
                                        <img alt="" src="assets/image/standard_post_img05.jpg"> </a>
                                    <span class="post-meta-category">
                                        <a href="#">Audio</a>
                                    </span>
            ...
            <ul class="pagination col-xl-12 mb-0">
